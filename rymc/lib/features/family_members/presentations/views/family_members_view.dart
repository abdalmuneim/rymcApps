...
class _FamilyMembersViewState extends State<FamilyMembersView> {
  late FamilyMembersProvider read = context.read<FamilyMembersProvider>();
  late FamilyMembersProvider watch = context.watch<FamilyMembersProvider>();
  @override
  void initState() {
    init();
    super.initState();
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Consumer<FamilyMembersProvider>(builder: (context, members, _) {
        return Scaffold(
          body: Padding(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      ListView.builder(
                        shrinkWrap: true,
                        itemCount: members.familyMembers.length,
                        itemBuilder: (context, index) {
                          User member = members.familyMembers[index];
                          return SizedBox(
                            height: 12.h,
                            child: Card(
                              elevation: 0,
